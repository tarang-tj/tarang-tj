...
<img src="assets/hero.svg" alt="Adversarial eval scoreboard: {{TRIALS}} questions put to this profile's retrieval harness, {{HELD}} answered from its own facts and {{BREAKS}} unanswered. Updated {{VERIFIED}}." width="880">
