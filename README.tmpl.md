...
<img src="assets/hero.svg" alt="Adversarial eval scoreboard: {{TRIALS}} questions asked of this profile's grounded bot, {{HELD}} answered from its own facts and {{BREAKS}} unanswered. Updated {{VERIFIED}}." width="880">
...
[**→ try to stump it**](https://github.com/tarang-tj/tarang-tj/issues/new?template=stump.yml&title=stump%3A+) &nbsp;·&nbsp; **{{TRIALS}}** trials · **{{RATE}}** answered · **{{OPEN}}** gaps still open
...
[portfolio](https://tarang-tj.github.io) · [linkedin](https://www.linkedin.com/in/tarang-tj/) · {{REPOS}} public repos · working in {{LANGS}}
